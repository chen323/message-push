...
public class RedisUtil {
    ...
    public Long zadd(final String key, final Map<String, Double> scoreMembers) {
        ...
        try {
            ...
            Long zadd = redisTemplate.opsForZSet().add(key,toTupleSet(scoreMembers));
    ...
    private static Set<ZSetOperations.TypedTuple<Object>> toTupleSet(Map<String, Double> scoreMembers) {
    ...
    public boolean delAllByMistyCacheKey(String cacheKeys) {
            redisTemplate.delete(redisTemplate.keys(cacheKeys));
            return true;
    }
}
