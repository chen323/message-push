...
import com.chen.msgpush.exception.AesException;
...
public class WXBizMsgCrypt {
    ...
    static {
        ...
        try {
            ...
            log.error("AESEncrypt static block error,", ex);
        }
    }
    ...
    public WXBizMsgCrypt(String token, String encodingAesKey, String receiveid) throws AesException {
        //log.info("WXBizMsgCrypt token: {}, encodingAesKey: {}, receiveid: {}", token, encodingAesKey, receiveid);
